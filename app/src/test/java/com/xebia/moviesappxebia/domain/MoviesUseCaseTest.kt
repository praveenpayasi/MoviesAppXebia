...
/**
 *  this class is having unit test cases for use case layer
 *
 */
class MoviesUseCaseTest {
    ...
    private val listOfDataPopularMovie: List<Result> = listOf(
        DataPopularMovie(
            ...
            genre_ids = listOf(0, 1, 2),
            id = 1,
            original_language = "en",
            original_title = "Movie 1",
            overview = "overview1",
            popularity = 10.0,
            poster_path = "image url 1",
    ...
    private val listOfDataNowPlayingMovie: List<ResultX> = listOf(
        DataNowPlaying(
            ...
            genre_ids = listOf(3, 4, 5),
            id = 3,
            original_language = "hi",
            original_title = "Movie 3",
            overview = "overview3",
            popularity = 20.0,
            poster_path = "image url 3",
            release_date = "10-1-2023",
            title = "Title3",
            video = true,
            vote_average = 70.0,
            vote_count = 3
        ...
        DataNowPlaying(
            adult = true,
            backdrop_path = "backdrop_path4",
            genre_ids = listOf(6, 7, 8),
            id = 4,
            original_language = "en",
            original_title = "Movie 4",
            overview = "overview4",
            popularity = 20.0,
            poster_path = "image url 4",
            release_date = "10-1-2023",
            title = "Title4",
            video = true,
            vote_average = 70.0,
    ...
    private val listOfProductionCompany: List<ProductionCompany> = listOf(
        ProductionCompany(
            ...
            name = "Name1",
            origin_country = "origin_country1"
        ),
        ProductionCompany(
            id = 2,
            logo_path = "logo_path2",
            name = "Name2",
            origin_country = "origin_country2"
        ),
    )
    ...
    private val moviesDetailResponse: MoviesDetailResponse = DataMovieDetails(
        ...
        popularity = 77.0,
        poster_path = "image url 1",
        production_companies = listOfProductionCompany,
        production_countries = listOfProductionCountry,
        release_date = "9-1-2023",
        revenue = 100,
        runtime = 10,
        spoken_languages = listOfSpokenLanguage,
        status = "status",
        tagline = "tagline",
        title = "Movie 1",
        video = true,
    ...
    private val listOfDomainMovieDetails: DomainMovieDetails =
        DomainMovieDetails(
            strImage = "${IMAGE_PATH}image url 1",
            strTitle = "Movie 1",
            strDate = "9-1-2023",
            strOverview = "Overview",
            strGenreTitle = listOfGenreTitle
        )
